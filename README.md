# Fleet Ledger: Driver & Vehicle Inventory Management System
...
| Storage          | Cloud object storage (for vehicle images & documents) |
...
3. Follow linting and test requirements
4. Submit a PR with clear context and validation steps
